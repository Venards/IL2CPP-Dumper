...
namespace api {
    ...
    typedef void* (*method_get_pointer_t)(void* method);
    ...
    typedef const char* (*metadata_string_literal_from_index_t)(uint32_t index);
    extern metadata_string_literal_from_index_t metadata_string_literal_from_index;
